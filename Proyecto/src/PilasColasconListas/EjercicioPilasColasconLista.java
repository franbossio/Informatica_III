...
public class EjercicioPilasColasconLista {
   ...
   public void ejecutar(){
    do{
        ...
        System.out.println("6-Implementa una cola que almacene números enteros. Luego, desencola y suma todos los números");
   ...
   private void ejercicio1(){
    ...
    private void ejercicio7(){
        ...
        while (!colaEntero.isEmpty()) {
            ...
            // Mueve los elementos de la pila a la cola hasta encontrar el lugar adecuado para 'temp'
